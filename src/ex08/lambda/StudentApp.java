...
public class StudentApp {
    public static void main(String[] args) {
        // 학생객체의 점수가 90점 이상이면 true를 반환, 출력하는 인터페이스
        ...
        StudentFilter filter2 = new StudentFilter() {
            @Override
